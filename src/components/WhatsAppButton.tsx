  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="glass rounded-2xl p-5 w-72 shadow-2xl"
          >
      ...
      <button
        ...
        className="w-14 h-14 rounded-full bg-primary text-primary-foreground shadow-lg hover:bg-accent hover:shadow-xl transition-all duration-300 flex items-center justify-center"
